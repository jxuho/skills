...
name: how
description: >
  Deep architectural investigation of a complex subsystem.
  Invoke only when the user explicitly asks to use "how" or "/how".
  Never auto-invoke for ordinary codebase questions.
---
